            ...
            if($axure.document.configuration.showAnnotationsSidebar) {
                ...
                if(widgetNotes) {
                    for(var i = 0; i < widgetNotes.length; i++) {
                        ...
                        var widgetNoteUi = "<div class='widgetNoteContainer' data1-id='" + widgetNote["id"] + "'>";
                    ...
                    $('.widgetNoteContainer').click(function () {
                        ...
                        $axure.messageCenter.postMessage('toggleSelectWidgetNote', this.getAttribute('data1-id'));
                    });
                }
            }
